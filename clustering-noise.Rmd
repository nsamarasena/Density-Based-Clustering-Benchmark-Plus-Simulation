...
noise3_x <- runif(30,-5,15)
noise3_y <- runif(30,-10,20)
noise3_z <- runif(30,-5,15)
...
trueXi2 <- c(rep(1,60),rep(2,150),rep('grey',30)) # generate labels for data
...
noise4_x <- runif(30,-15,0)
noise4_y <- runif(30,-2,16)
noise4_z <- runif(30,0,15)
...
trueX2i <- c(rep(3,150),rep(4,60),rep('grey',30))
