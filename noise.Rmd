...
## commented out code chunks are the datasets which will not have noise added
...
noise_x <- runif(50,-5,5)
noise_y <- runif(50,-5,5)
noise_z <- runif(50,-10,35)
...
trueX3 <- c(rep(5:7,each=200),rep(1,50))
